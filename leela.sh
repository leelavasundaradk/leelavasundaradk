...
#    global_url="http://leelavasundaradk.local"
    global_url="http://leelavasundaradk.github.io"
#    global_url="https://leelavasundaradk.co.in"

    # Your name
    global_author="Leela Vasundhara"
    # You can use twitter or facebook or anything for global_author_url
    global_author_url="https://www.quora.com/profile/Leela-Vasundhara-Dondla"
    # Your email
    global_email="leelavasundaradk@gmail.com"

    # CC by-nc-nd is a good starting point, you can change this to "&copy;" for Copyright
    global_license="Copyright 2020"
...
create_includes() {
    ...
    if [[ -f $footer_file ]]; then cp "$footer_file" .footer.html
        ...
        echo "<div id=\"footer\">$global_license </br></br><a href=\"$global_author_url\">$global_author</a> &mdash; <a href=\"mailto:$protected_mail\">$protected_mail</a><br/>"
        echo '</div>'
...
create_css() {
    ...
    if [[ -f ../style.css ]] && [[ ! -f main.css ]]; then
        ...
        .headerholder{background-color:#f9f9f9;border-top:solid 1px #ccc;border-left:solid 1px #ccc;border-right:solid 1px #ccc;padding: 0px 48px 0px 48px;}
